...
class Computation{
    ...
    public:
        ...
        */
        ...
        /**
         * @brief Add edges to the graph
         * @param newEdgesList: the list of edges to be added to the graph, in the form of a vector of couple of integers, representing the edge(node ids) and its weight
         * @param newEdgesValue: the list of edges weights to be added to the graph, in the form of a vector of doubles (default is an empty vector, so no values are added)
         * @param bothDirections: if true, the edges will be added in both directions (default is false)
         * @param inverseComputation: if true, the pseudo-inverse of the augmented graph will be computed (default is true)
         * @details The function will add the edges to the graph and compute the pseudo-inverse of the augmented graph if inverseComputation is true.
        ...
        /**
         * @brief Compute the perturbation of the augmented graph with dissipation. The dissipation is done after propagation
         * @details The function will compute the perturbation of the augmented graph using the pseudo-inverse of the augmented graph and the input vector.
        ...
        /**
         * @brief Compute the perturbation of the augmented graph with dissipation. The dissipation is done before propagation
         * @details The function will compute the perturbation of the augmented graph using the pseudo-inverse of the augmented graph and the input vector.
         * @param timeStep: the time step for the dissipation
         * @return The perturbation vector.
         * @warning function is deprecated, left for backward compatibility and testing purposes
        ...
        /**
         * @brief Compute the perturbation of the augmented graph with dissipation and saturation. The dissipation is done before propagation
         * @details The function will compute the perturbation of the augmented graph using the pseudo-inverse of the augmented graph and the input vector.
         * @param timeStep: the time step for the dissipation
        ...
        /**
         * @brief Compute the perturbation of the augmented graph with dissipation, conservation and saturation. The dissipation is done before propagation
         * @details The function will compute the perturbation of the augmented graph using the pseudo-inverse of the augmented graph and the input vector.
         * @param timeStep: the time step for the dissipation
         * @param saturationsVector: the saturation vector for the dissipation(default to empty vector)
         * @return The perturbation vector.

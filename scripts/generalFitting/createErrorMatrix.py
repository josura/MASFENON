...
The script will create an error matrix in a file specified by the user. The error matrix will contain the differences between the simulated and real data for each time point and node.
"""
...
dir.create("syntheticGraphsDifferentNodes", showWarnings = FALSE)
...
for (i in 1:30){
  ...
  dir.create(paste0("syntheticGraphsDifferentNodes/",num_nodes,"Nodes/"), showWarnings = FALSE)
  create_input_graphs(graph, node_conditions, community_data, paste0("syntheticGraphsDifferentNodes/",num_nodes,"Nodes/"))
  # Write data to tsv files
  write_tsv(edge_data, paste0("syntheticGraphsDifferentNodes/",num_nodes,"Nodes/edge_data.tsv"), quote = "none",append = FALSE)
  write_tsv(node_conditions, paste0("syntheticGraphsDifferentNodes/",num_nodes,"Nodes/node_conditions.tsv"), quote = "none",append = FALSE)
  write_tsv(community_data, paste0("syntheticGraphsDifferentNodes/",num_nodes,"Nodes/communities.tsv"), quote = "none",append = FALSE)
